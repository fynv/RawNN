...
class BlazeFace(nn.Module):
    ...
    def __init__(self):
        ...
        self._define_layers()
        # self.regressor_16.register_forward_hook(self.layer_hook)

    def layer_hook(self, _self, input, output):
    ...
    def predict_on_batch(self, x):
        ...
        # torch.stack(detections).cpu().detach().numpy().tofile("detections")
